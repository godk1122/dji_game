...
{   
    ...
    timeA_5 = 12.0;
    timeA_6 = 6.0;
    timeA_all = timeA_1 + timeA_2 + timeA_3 + timeA_4 + timeA_5 + timeA_6;
...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    for (double t = 0.0; t < time_all; t += 0.1)
    {
      ...
      if (t <= timeA_1 + timeA_2 + timeA_3)
      {
        traj_msg_.yaw.push_back(-0);
      }

      else if (t> timeA_1 + timeA_2 + timeA_3 && t <= timeA_1 + timeA_2 + timeA_3 + timeA_4)
      {
        traj_msg_.yaw.push_back(M_PI/4);
      }
      
      else if (t > timeA_1 + timeA_2 + timeA_3 + timeA_4 && t <= timeA_all + timeB_all + timeBC)
      {
